const { St, GLib, Gio, GObject, Soup } = imports.gi
...
const CommandsFeedClass = GObject.registerClass(
    class CommandsFeedClass extends PanelMenu.Button {
        _init () {
            super._init(1)
        ...
        _fetch (callback) {
            ...
            const request = Soup.Message.new('GET', 'http://www.commandlinefu.com/commands/random/json')
